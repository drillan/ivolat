...
pc_dict = {0: 0, 1: 1, 'c': 0, 'C': 0, 'p': 1, 'P': 1}
...
def prem(s, k, r, q, t, sigma, pc):
    return prem_dict[porc(pc)](s, k, r, q, t, sigma)


def delta(s, k, r, q, t, sigma, pc):
    return delta_dict[porc(pc)](s, k, r, q, t, sigma)


def theta(s, k, r, q, t, sigma, pc):
    return theta_dict[porc(pc)](s, k, r, q, t, sigma)


def rho(s, k, r, q, t, sigma, pc):
    return rho_dict[porc(pc)](s, k, r, q, t, sigma)


def charm(s, k, r, q, t, sigma, pc):
    return charm_dict[porc(pc)](s, k, r, q, t, sigma)


def dualdelta(s, k, r, q, t, sigma, pc):
    return dualdelta_dict[porc(pc)](s, k, r, q, t, sigma)
